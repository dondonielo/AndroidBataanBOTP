...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        Button scanButton = (Button) findViewById(R.id.scan_device_button);
        
        Typeface font = Typeface.createFromAsset(getAssets(), "fonts/androidnation.ttf");
        TextView sButton = (TextView) findViewById(R.id.scan_device_button);
        sButton.setTypeface(font);
        ...
        if (pairedDevices.size() > 0) {
            findViewById(R.id.paired_device_title).setVisibility(View.VISIBLE);
